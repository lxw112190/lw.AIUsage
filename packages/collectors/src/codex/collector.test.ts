...
describe("Codex collector", () => {
  it("discovers and scans a fixture incrementally", async () => {
    const platform = createFixturePlatform({ "/fixture/.codex/sessions/demo.jsonl": '{"type":"session_meta","payload":{"session_id":"s1","cwd":"demo"}}\n{"type":"turn_context","payload":{"model":"gpt-5-codex"}}\n{"type":"token_count","timestamp":1725436920000,"payload":{"usage":{"input_tokens":10,"output_tokens":5}}}\n' });
    ...
    const second = await collector.scanFile({ platform, file: files[0]!, cursor: result.cursor });
